...
<table cellspacing="2" cellpadding="0" border="0" width="100%">
        <tr>
            <td>
                <input type="image" name="<portletAPI:encodeNamespace value='edit_done'/>" value="edit_done" src='<%= portletResponse.encodeURL("/images/INS/header_ok.gif")%>' align="middle" alt="<portletAPI:text key="dcBase.ok" bundle="<%= nls %>"/>" border="0">
                &nbsp;<span class="wpsTaskIconText"><portletAPI:text key="dcBase.ok" bundle="<%= nls %>"/></SPAN>&nbsp;
                <IMG src='<%= portletResponse.encodeURL("/images/INS/header_divider.gif")%>' align="middle" border="0" alt="">&nbsp;
                <input type="image" name="<portletAPI:encodeNamespace value='cancel'/>" value="cancel" src='<%= portletResponse.encodeURL("/images/INS/header_cancel.gif")%>' align="middle" alt="<portletAPI:text key="dcBase.cancel" bundle="<%= nls %>"/>" border="0">
                &nbsp;<span class="wpsTaskIconText"><portletAPI:text key="dcBase.cancel" bundle="<%= nls %>"/></SPAN>&nbsp;
                <%if(modifyMode){%>
                   <IMG src='<%= portletResponse.encodeURL("/images/INS/header_divider.gif")%>' align="middle" border="0" alt="">&nbsp;
                   <input type="image" name="<portletAPI:encodeNamespace value='delete'/>" value="delete" src='<%= portletResponse.encodeURL("/images/INS/delete_box.gif")%>' align="middle" alt="<portletAPI:text key="dcBase.delete_dc" bundle="<%= nls %>"/>" border="0">
                   &nbsp;<span class="wpsTaskIconText"><portletAPI:text key="dcBase.delete" bundle="<%= nls %>"/></SPAN>&nbsp;
                <%}%>
            </td>
        </tr>
        <tr>
...
<% } %>
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
      ...
      <%}
        ...
        <tr>
            <td class="wpsLabelText">
                <span class="wpsLabelText"><label for="<portletAPI:encodeNamespace value="userid"/>"><portletAPI:text key="dcAol.st_id_label" bundle="<%= nls %>"/></label></span>
                <br>
        ...
        <td>
                ...
                <td class="wpsLabelText">
                    <select name="<portletAPI:encodeNamespace value='fromTime'/>" id="<portletAPI:encodeNamespace value='fromTime'/>">
                        ...
                        for(int i = 0; i < numberOfTimeChoices; i++)
                        {
                            ...
                            %>
                            <option value="<%= timeCodeFormat.format(date)%>"/><%= timeFormat.format(date)%>
                            <%
                        }
                        %>
                    </select>
            ...
            <tr>
                <td class="wpsLabelText" align="left" colspan="3">
                    <input type="image" align="middle" name="<portletAPI:encodeNamespace value='addDelay'/>" value="addDelay" src='<%= portletResponse.encodeURL("/images/INS/add.gif")%>' align="absmiddle" title="<portletAPI:text key="dcBase.add_time_period" bundle="<%= nls %>"/>" alt="<portletAPI:text key="dcBase.add_time_period" bundle="<%= nls %>"/>" border="0">
            ...
            <tr>
                <td class="wpsLabelText" align="left" colspan="3">
                    <input type="image" align="middle" name="<portletAPI:encodeNamespace value='deleteDelay'/>" value="deleteDelay"  src='<%= portletResponse.encodeURL("/images/INS/delete.gif")%>' align="top" title="<portletAPI:text key="dcBase.delete_time_period" bundle="<%= nls %>"/>" alt="<portletAPI:text key="dcBase.delete_time_period" bundle="<%= nls %>"/>" border="0">
                    &nbsp;<span class="wpsDialogIconText"><portletAPI:text key="dcBase.delete_time_period" bundle="<%= nls %>"/></SPAN>&nbsp;
                </td>
            </tr>
            <tr>
                <td colspan="3">
                    <select name="<portletAPI:encodeNamespace value="selectedDelayTime"/>" id="<portletAPI:encodeNamespace value="selectedDelayTime"/>" SIZE="4" width="100%" style="width:100%;">
                    <%
                     if(delayTimes != null)
                     {
